...
<label for="title">[+lang.title+]:</label> <div class="field"><input type="text" name="title" id="title" value="[+title+]" size="35" /></div>
...
<label for="title">[+lang.keywords+]:</label> <div class="field"><input type="text" name="keywords" id="keywords" value="[+keywords+]" size="35" />[+keyword_tagList+]</div>
<div class="submit">
