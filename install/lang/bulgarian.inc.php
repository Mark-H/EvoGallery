...
$_lang["welcome_message_start"] = 'На първо място, изберете опциите за инсталиране и натиснете бутона Инсталиране:';
$_lang["welcome_message_text"] = 'Тази програма ще ви води през останалата част от инсталацията.';
$_lang["welcome_message_welcome"] = 'Добре дошли в Инсталатора на MODx Gallery.';
