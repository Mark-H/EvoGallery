...
$_lang["welcome_message_start"] = 'Во-первых, выбрать параметры установки и нажмите Установить:';
$_lang["welcome_message_text"] = 'Эта программа проведет вас через весь процесс установки.';
$_lang["welcome_message_welcome"] = 'Добро пожаловать в программу установки MODx Gallery.';
